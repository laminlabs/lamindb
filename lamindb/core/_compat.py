...
def with_package(package_name: str, operation: Callable[[Any], T]) -> T:
    ...
    Returns:
        Result of operation if package is available, None otherwise
...
def apply_class_func(
    ...
    Returns:
        Tuple with boolean indicating if object was handled
        and the result of the operation (if handled)

    Examples:
        # For instance methods
        handled, _ = apply_class_func(dmem, "MuData", "mudata",
