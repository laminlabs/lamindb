...
if version.parse(lndb_setup_v) != version.parse("0.30.14"):
    raise RuntimeError("Upgrade lndb_setup! pip install lndb_setup==0.30.14")

if version.parse(lnschema_core_v) != version.parse("0.25.11"):
    raise RuntimeError("lamindb needs lnschema_core==0.25.11")
