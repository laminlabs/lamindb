...
if version.parse(lnschema_core_v) != version.parse("0.18.0"):
    raise RuntimeError("lamindb needs lnschema_core==0.18.0")
...
if version.parse(bionty_v) != version.parse("0.5.3"):
    raise RuntimeError("lamindb needs bionty==0.5.3")
