...
if version.parse(lndb_setup_v) != version.parse("0.9.2"):
    raise RuntimeError("lamindb needs lndb_setup==0.9.2")
...
if version.parse(lnbfx_v) < version.parse("0.4.1"):
    raise RuntimeError("lamindb needs lnbfx>=0.4.1")
