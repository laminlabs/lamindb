...
if version.parse(lndb_setup_v) != version.parse("0.30.8"):
    raise RuntimeError("Upgrade lndb_setup! pip install lndb_setup==0.30.8")

if version.parse(lnschema_core_v) != version.parse("0.25.1"):
    raise RuntimeError("lamindb needs lnschema_core==0.25.1")
