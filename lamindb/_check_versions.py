...
if version.parse(lnschema_core_v) != version.parse("0.9.0"):
    raise RuntimeError("lamindb needs lnschema_core==0.9.0")
...
if version.parse(lnbfx_v) < version.parse("0.4.0"):
    raise RuntimeError("lamindb needs lnbfx>=0.4.0")
