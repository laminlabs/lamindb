...
if version.parse(lnschema_core_v) != version.parse("0.5.0"):
    raise RuntimeError("lamindb needs lnschema_core==0.5.0")

if version.parse(lnschema_wetlab_v) != version.parse("0.3.1"):
    raise RuntimeError("lamindb needs lnschema_wetlab==0.3.1")
...
if version.parse(lnbfx_v) != version.parse("0.3.0"):
    raise RuntimeError("lamindb needs lnbfx==0.3.0")
