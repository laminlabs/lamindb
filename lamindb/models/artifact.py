...
def process_data(
    ...
    if key_suffix is not None and key_suffix != suffix and not is_replace:
        ...
        if isinstance(data, (str, Path, UPath)):  # UPathStr, spelled out
            message = f"The passed path suffix '{suffix}' must match the passed key suffix '{key_suffix}'."
        else:
            message = f"The passed key suffix '{key_suffix}' must match the passed path suffix '{suffix}'."
