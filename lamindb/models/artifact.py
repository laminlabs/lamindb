        ...
        **expressions,
        ...
        Examples:
            ...
            Query by fields::
                ...
                ln.Artifact.filter(key="examples/my_file.parquet")

            Query by features, e.g. for a feature `"cell_type_by_model"`::

                ln.Artifact.filter(cell_type_by_model__name="T cell")
