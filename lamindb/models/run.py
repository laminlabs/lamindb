...
class Run(SQLRecord, TracksUpdates):
    ...
    """The artifacts generated by this run ← :attr:`~lamindb.Artifact.run`.
    """
    ...
    """The collections generated by this run ← :attr:`~lamindb.Record.run`."""
    ...
    """The collections generated by this run ← :attr:`~lamindb.Collection.run`."""
