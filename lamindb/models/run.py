...
class Run(SQLRecord):
    ...
    """The artifacts serving as input for this run, linked via :attr:`~lamindb.Artifact.input_of_runs`.
    """
    output_artifacts: Artifact
    """The artifacts generated by this run, linked via :attr:`lamindb.Artifact.run`.
    """
    recreated_artifacts: Artifact
    """The output artifacts that were recreated by this run but originally created in another run, linked via :attr:`lamindb.Artifact.recreating_runs`.
    ...
    """The collections serving as input for this run, linked via :attr:`lamindb.Record.input_of_runs`."""
    output_records: Record
    """The collections generated by this run, linked via :attr:`lamindb.Record.run`."""
    input_collections: Collection
    """The collections serving as input for this run, linked via :attr:`lamindb.Collection.input_of_runs`."""
    output_collections: Collection
    """The collections generated by this run, linked via :attr:`lamindb.Collection.run`."""
    recreated_collections: Collection
    """The output collections that were recreated by this run but originally created in another run, linked via :attr:`lamindb.Collection.recreating_runs`.
