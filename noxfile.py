...
def install_ci(session, group):
    ...
    run(session, "uv pip install --system s3fs==2025.2.0")
    run(session, "uv pip install --system gcsfs==2025.2.0")
    run(session, "uv pip install --system universal_pathlib==0.2.6")
