...
For an in-depth example and a complex dataset, read this blog post: [blog.lamin.ai/1000genomes](https://blog.lamin.ai/1000genomes). For more background on the query architecture, read {doc}`architecture`.
